  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm px-4 py-3 flex items-center justify-between sticky top-0 z-30 shadow-sm border-b border-slate-100 transition-all duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link to="/profile" className="w-9 h-9 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md ring-2 ring-white hover:ring-primary-100 transition-all">
          {USER.initials}
        </Link>
      </div>
    </div>
